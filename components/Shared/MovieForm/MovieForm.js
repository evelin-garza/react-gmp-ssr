            ...
            {props => (
                <Form>
                    ...
                    <div className={styles['form-actions']}>
                        <input type="button" className={`${styles.btn} ${styles['btn-red-outline']}`} value="RESET" onClick={props.resetForm} />
                        <input type="submit" className={`${styles.btn} ${styles['btn-filled-red']}`} value="SUBMIT" disabled={props.isSubmiting} />
                    </div>
                </Form>
            )}
